...
const state = reactive({
  ...
  { label: '用户', property: 'username', render:'component',  type: 'select',width:160,   options: userOptions , attr: {allowCreate:true,onPropValChange:usernameChange}},
  //限制正数输入,保留两位小数
  ...
  //可以输入负数，限制最大最小值
  { label: '学分', property: 'score', render:'component',  type: 'input', attr: {type:'number',number:'positiveNegative',max:100,min:-100} , validate:true},  
  { label: '生日年月', property: 'birthday', render:'component',  type: 'date' ,width:160, attr:{type:'month',format:'YYYYMM',valueFormat:'YYYYMM'} , validate:true}, 
  { label: '提交日期', property: 'createtime',width:180},  
  { label: '更新时间', property: 'updatetime',width:180 },  
]})
const {columns,tableData} = toRefs(state)

// tableData数组设置 以columns的property数据为属性的数据 
let data = [
{"id":2,"city":1,"area":1,"username":3,"account":4,"age":5,"createtime":"2024-01-01",birthday:"202405",score:5,"updatetime":"2024-04-01",readonlyKeyList:[]},
{"id":3,"city":2,"area":3,"username":3,"account":4,"age":5,"createtime":"2024-01-02",birthday:"202406",score:-2,"updatetime":"2024-04-02",readonlyKeyList:[],ignoreList:['birthday']}, 
{"id":4,"city":3,"area":5,"username":3,"account":4,"age":5,"createtime":"2024-01-03",birthday:"202407",score:10,"updatetime":"2024-04-03",readonlyKeyList:['city', 'area',]},//支持设定某一行部分字段临时不能编辑
{"id":5,"city":4,"area":2,"username":3,"account":4,"age":5,"createtime":"2024-01-04",birthday:"202408",score:20,"updatetime":"2024-04-04",readonlyKeyList:[]},
{"id":6,"city":5,"area":2,"username":3,"account":4,"age":5,"createtime":"2024-01-05",birthday:"202409",score:-1,"updatetime":"2024-04-05",readonlyKeyList:[]},
{"id":7,"city":6,"area":2,"username":3,"account":4,"age":5,"createtime":"2024-01-06",birthday:"202410",score:-2,"updatetime":"2024-04-06",readonlyKeyList:[]},
{"id":8,"city":7,"area":2,"username":3,"account":4,"age":5,"createtime":"2024-01-07",birthday:"202405",score:-3,"updatetime":"2024-04-07",readonlyKeyList:[]},
{"id":9,"city":8,"area":2,"username":3,"account":4,"age":5,"createtime":"2024-01-08",birthday:"202405",score:-4,"updatetime":"2024-04-08",readonlyKeyList:[]},
{"id":10,"city":9,"area":2,"username":3,"account":4,"age":5,"createtime":"2024-01-09",birthday:"202405",score:20,"updatetime":"2024-04-09",readonlyKeyList:[]}];
  ...
  const createRow = () => {
  let row = {"id": tableData.value.length + 1,"city":1,"area":1,"username":3,"account":4,"age":5,"createtime":"2024-01-01",birthday:"202405","updatetime":"2024-04-01"}
